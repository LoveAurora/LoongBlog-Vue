    ...
    <div class="container">
      ...
      <div v-show="!err2005" class="">
        ...
        <div v-else class="registerBox">
          ...
          <el-input type="text" placeholder="用户名" v-model="nusername">
          </el-input>
          <el-alert
            v-show="nusernameErr"
            title="用户名错误"
          ...
          <el-input type="text" placeholder="昵称" v-model="nnickName">
          </el-input>
          <el-input type="email" placeholder="邮箱" v-model="nemail">
          </el-input>
          <el-alert
            v-show="nemailErr"
            title="邮箱错误"
